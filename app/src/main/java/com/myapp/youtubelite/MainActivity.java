package com.myapp.youtubelite;
    ...
    public class MainActivity extends Activity {
      ...
      // This guarantees the receiver is unregistered every time the Activity goes to
      // background, preventing leaked registrations across configuration changes
      // (screen rotation etc.) and Activity recreations.
      @Override
      protected void onStart() {
          ...
          if (playbackActionReceiver != null) {
              ...
              if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
                  // FIX BUG #7 (Security): RECEIVER_NOT_EXPORTED prevents external apps
                  // from sending fake playback commands to this receiver.
      ...
      protected void onStop() {
          super.onStop();
          // FIX BUG #4: Always unregister when the Activity goes to background
          if (playbackActionReceiver != null) {
              try {
      ...
      protected void onPause() {
          super.onPause();
          // Do NOT pause webView — allows background audio playback
      }
